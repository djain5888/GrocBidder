...
return (
  ...
  //   <img src={logo} alt="Logo" className={titleBarStyle.logoImage} /> {/* Add your logo image here */}
  ...
  <div className={titleBarStyle["title-bar"]} ref={ref}>
  <div className={titleBarStyle.logo}>
    <img src={logo} alt="Logo" className={titleBarStyle.logoImage} />
  </div>
  <div className={titleBarStyle["centered-text"]}>{pageInfo}</div>
  <div className={titleBarStyle["user-profile-name"]} onClick={toggleOptions}>
  ...
  {showOptions && (
    <div className={titleBarStyle["options-wrapper"]}>
      <div className={titleBarStyle["options-container"]}>
        <span className={titleBarStyle["user-profile-email"]}>
